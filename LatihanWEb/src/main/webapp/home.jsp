...
String namaBelakang = (String)session.getAttribute("namaBelakang");
  // Sekarang, nilai alamat email dapat digunakan dalam halaman listmahasiswa.jsp
  if(userEmail == null){
    ...
    <div class="container-fluid bg-light position-relative shadow">
      ...
      >
        ...
        >
          ...
          <a href="" class="btn btn-primary px-4 nav-link dropdown-toggle" data-toggle="dropdown">Hi, <%= namaDepan + " " + namaBelakang %> !</a>
              <div class="dropdown-menu rounded-5 mb-10">
                <a onclick="return confirm('Apakah anda yakin ingin keluar ?')" href="index.jsp" class="dropdown-item">Logout</a> 
              </div>
            </div>
