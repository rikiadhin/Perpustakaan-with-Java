...
<head>
<meta charset="utf-8" />
<title>KidKinder - Peminjaman</title>
...
<%
	...
	<div class="container-fluid bg-primary mb-5">
		<div
			...
			<h3 class="display-3 font-weight-bold text-white">Peminjaman</h3>
	...
	<table id="bookTable">
		...
		<tbody>
			...
			int jumlah = pinjambukuModel.getAllData().size();
			int no = 1;
			%>
			...
			<tr>
				<td>
					<%
					out.print(pinjambukuModel.getAllData().get(i).getIdPinjam());
					%>
				</td>
				<td>
					<%
					out.print(pinjambukuModel.getAllData().get(i).getIdAnggota());
					%>
				</td>
				<td>
					<%
					out.print(pinjambukuModel.getAllData().get(i).getNamaDepan() + " "
							+ pinjambukuModel.getAllData().get(i).getNamaBelakang());
					%>
				</td>
				<td>
					<%
					out.print(pinjambukuModel.getAllData().get(i).getIdBuku());
					%>
				</td>
				<td>
					<%
					out.print(pinjambukuModel.getAllData().get(i).getJudul());
					%>
				</td>
				<td>
					<%
					out.print(pinjambukuModel.getAllData().get(i).getKategori());
					%>
				</td>
				<td>
					<%
					out.print(pinjambukuModel.getAllData().get(i).getTanggalPinjam());
					%>
				</td>
				<td>
					<%
					out.print(pinjambukuModel.getAllData().get(i).getTanggalKembali());
					%>
				</td>
				<td><a
					href="pinjam/editPinjam.jsp?idpinjam=<%out.print(pinjambukuModel.getAllData().get(i).getIdPinjam());%>">
