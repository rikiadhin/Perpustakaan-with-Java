...
<head>
<meta charset="utf-8" />
<title>KidKinder - Category</title>
...
<body>
	<%@ page import="database.Kategori, database.KategoriModel"%>
	<%
	...
	<div class="container-fluid bg-primary mb-5">
		<div
			...
			<h3 class="display-3 font-weight-bold text-white">Category</h3>
	...
	<div class="container-fluid pt-5">
		<div class="container pb-3">
			<div class="row">
				...
				%>
				<div class="col-lg-4 col-md-6 pb-1 pb-5">
					<div class="d-flex bg-light shadow-sm border-top rounded mb-4"
						style="padding: 20px; border: 1px solid #ccc; height: 100%;">
						<i
							class="flaticon-050-fence h1 font-weight-normal text-primary mb-3"></i>
						<div class="pl-4">
							<h4>
								<%
								out.print(kategoriModel.getAllData().get(i).getKategori());
								%>
							</h4>
							<p class="m-0"
								style="white-space: wrap; overflow: hidden; text-overflow: ellipsis; max-width: 100%;"
								title="<%out.print(kategoriModel.getAllData().get(i).getDeskripsi());%>">
								<%
								String deskripsi = kategoriModel.getAllData().get(i).getDeskripsi();
								if (deskripsi.length() > 50) {
									out.print(deskripsi.substring(0, 50) + "...");
								} else {
									out.print(deskripsi);
								}
								%>
